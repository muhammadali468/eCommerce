      ...
      <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div className="mx-auto grid max-w-7xl px-4 pb-8 md:grid-cols-12 lg:gap-12 lg:pb-16 xl:gap-0">
          <div className="content-center justify-self-start md:col-span-7 md:text-start">
            <h1 className="mb-4 text-4xl inter-tight-bold leading-none tracking-tight dark:text-white md:max-w-3xl md:text-5xl xl:text-6xl">Welcome to E-Commerce Site!<br />Up to 50% OFF!</h1>
            ...
            <div className="flex gap-4">
              <Link to="/shop" className="bg-[#95BDD8] text-black border-black inline-block rounded-lg bg-primary-700 px-6 py-3.5 text-center font-medium text-white hover:bg-primary-800 dark:border dark:border-white focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Shop Now</Link>
